    ...
    @auth
        @if (auth()->user()->status === 'Suspended')
            <div class="max-w-7xl mx-auto px-6 pt-40">
                <div
                    class="mb-8 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/50 p-5 rounded-2xl flex items-start shadow-sm transition-colors">
                    <div class="flex-shrink-0 bg-red-100 dark:bg-red-900/50 p-2 rounded-full">
                    ...
                    <div class="ml-4">
                        <h3 class="text-sm font-bold text-red-800 dark:text-red-400 tracking-wide uppercase">Akses Pemesanan
                            Diblokir</h3>
                        <p class="text-sm text-red-600 dark:text-red-300 mt-1 leading-relaxed">
                            Akun Anda saat ini sedang dalam status ditangguhkan. Anda masih dapat menjelajahi katalog, namun
                            tidak dapat melakukan pemesanan ruang baru. Silakan hubungi admin perpustakaan untuk memulihkan
                            status Anda.
                        </p>
                    </div>
                </div>
                ...
                <div class="max-w-7xl mx-auto px-6">
                    ...
                    @if (session('status'))
                        <div
                            ...
                            <svg class="w-5 h-5 text-emerald-500 dark:text-emerald-400 shrink-0" fill="none"
                        ...
                        <div class="lg:col-span-5 space-y-6">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div
                                        class="flex items-center gap-3 text-sm font-semibold text-slate-600 dark:text-slate-300">
                        ...
                        <div class="lg:col-span-7 w-full" id="booking-card">
                            <div
                                ...
                                <div class="mb-6 pb-4 border-b border-slate-100 dark:border-slate-700">
                                    ...
                                    <p class="text-xs text-slate-400 mt-1">Silakan tentukan jadwal penggunaan ruang diskusi
                                        Anda.
                                ...
                                @else
                                    <form action="{{ route('booking.store', $ruangan->id) }}" method="POST"
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input type="time" id="jam_mulai" name="jam_mulai"
                                                    value="{{ old('jam_mulai', '08:00') }}" min="08:00" max="16:00"
                                                    required
                                                    class="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-600 bg-slate-50/50 dark:bg-slate-900 focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all text-sm font-medium text-slate-700 dark:text-slate-200 [color-scheme:light] dark:[color-scheme:dark]">
                                            </div>
                                            <div>
                                        ...
                                        <div
                                            ...
                                            <strong class="dark:text-orange-400">Pemberitahuan Sistem:</strong> Pengajuan
                                            booking
                                            akan berstatus <span class="font-bold">Pending</span> terlebih dahulu untuk
                                            menunggu
            ...
            <section
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-1">Daftar mahasiswa yang telah memesan atau sedang mengantre di
                            ruangan
                            ini.</p>
                    </div>
                </div>
