    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="hidden md:flex space-x-8 items-center">
                <a href="/"
                    class="text-sm font-semibold @if (request()->is('/')) text-orange-600 @else text-slate-500 @endif hover:text-orange-600 transition-colors">Beranda</a>
                <a href="/tentang"
            ...
            <div class="hidden md:flex animate-pulse items-center space-x-4">
