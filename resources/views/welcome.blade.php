...
<body class="bg-slate-50 text-slate-800 antialiased overflow-x-hidden">
    <nav class="fixed w-full z-50 glass-panel border-b border-white/20 transition-all duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex space-x-8 items-center">
                    <a href="#home"
                        class="text-sm font-semibold text-slate-900 hover:text-orange-600 transition-colors">Beranda</a>
                    <a href="#features"
                        class="text-sm font-medium text-slate-500 hover:text-orange-600 transition-colors">Fitur</a>
                    <a href="#how-it-works"
                        class="text-sm font-medium text-slate-500 hover:text-orange-600 transition-colors">Cara
                        Kerja</a>
                    <a href="#ai-assistant"
                        class="text-sm font-medium text-slate-500 hover:text-orange-600 transition-colors flex items-center gap-1">
                        Asisten AI
                    ...
                    <a href="{{ route('dashboard') }}"
                        class="text-sm font-medium text-slate-500 hover:text-orange-600 transition-colors">Dashboard</a>
                </div>
        ...
        <section id="home" class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                <div class="flex items-center justify-center pb-2 w-full">
                    <img src="{{ asset('unej-logo.png') }}" alt="logo" width="100" class="animate-bounce" />
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm">
                        ...
                        <li>
                            <a href="#features" class="hover:text-orange-600 transition-colors">Fitur Utama</a>
                        </li>
                        <li>
                            <a href="#how-it-works" class="hover:text-orange-600 transition-colors">Cara Kerja</a>
                        </li>
                        <li>
                            <a href="#ai-assistant" class="hover:text-orange-600 transition-colors">Asisten AI</a>
                        </li>
                        <li>
    ...
    <div class="fixed bottom-6 right-6 z-[100] flex flex-col items-end">
        ...
        <button onclick="toggleChat()" id="chat-fab"
            ...
            <svg class="w-6 h-6 transform transition-transform group-hover:-rotate-12" fill="none"
