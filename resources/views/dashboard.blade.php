...
<head>
    ...
    <title>Manajemen Ruang Perpustakaan</title>
...
<body
    ...
    <div class="flex h-screen w-full">
        <div
            class="lg:hidden fixed top-0 left-0 right-0 h-16 bg-white border-b border-slate-100 z-50 flex items-center justify-between px-4">
            <a href="">
                <img src="Libmate.png" width="130" alt="Logo LibMate" />
            </a>
            <button id="mobileMenuBtn" class="p-2 text-slate-500 hover:text-orange-400 transition-colors">
        ...
        <aside id="sidebar"
            ...
            <div class="flex flex-col flex-1 px-4 py-6 gap-2 overflow-y-auto">
                ...
                <a href="#"
                    class="flex items-center gap-3 px-4 py-3 rounded-2xl bg-orange-400 text-white shadow-md shadow-orange-200 transition-all">
                    <i data-lucide="layout-dashboard" class="w-5 h-5"></i>
                    <span class="font-medium">Manajemen Ruang</span>
                </a>
            </div>
        ...
        <div id="sidebarOverlay"
            class="fixed inset-0 bg-slate-800/50 z-30 hidden lg:hidden backdrop-blur-sm transition-opacity"></div>
            ...
            <div class="p-6 md:p-8 lg:p-10 max-w-7xl mx-auto">
                <header class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                    ...
                    <div class="flex items-center gap-4 w-full md:w-auto">
                        ...
                        <button
                            class="bg-white p-2.5 rounded-full shadow-sm text-slate-500 hover:text-orange-400 relative">
                            ...
                            <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm h-fit">
                                ...
                                <form id="booking-form" class="space-y-4">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <label
                                                class="block text-sm font-medium text-slate-700 mb-1">Tanggal</label>
        ...
        <aside class="hidden xl:flex w-80 bg-white border-l border-slate-100 flex-col h-full overflow-y-auto">
            <div class="p-8 pb-6 flex flex-col items-center border-b border-slate-50">
                <div class="relative mb-4">
                    <img src="https://ui-avatars.com/api/?name=Rara+A&background=FB923C&color=fff&size=120"
                        alt="Profile" class="w-24 h-24 rounded-full border-4 border-white shadow-md" />
                    <div class="absolute bottom-1 right-1 w-4 h-4 bg-emerald-400 border-2 border-white rounded-full">
                    </div>
                </div>
                ...
                <div class="flex gap-4 w-full mt-6">
                    <div class="bg-orange-50 rounded-2xl p-3 flex-1 text-center">
                        <p class="text-[10px] text-orange-500 font-semibold uppercase tracking-wider">
                            Mulai Kerja
                        </p>
                        <p class="font-bold text-orange-600 mt-1">09:00</p>
                    </div>
